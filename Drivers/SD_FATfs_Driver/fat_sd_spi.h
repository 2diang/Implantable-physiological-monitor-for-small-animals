...
#define spi_cs_low()   HAL_GPIO_WritePin(SD_CS_GPIO_Port,SD_CS_Pin,GPIO_PIN_RESET)
#define spi_cs_high()  HAL_GPIO_WritePin(SD_CS_GPIO_Port,SD_CS_Pin,GPIO_PIN_SET)
...
enum sd_speed { SD_SPEED_INVALID, SD_SPEED_125KHZ, SD_SPEED_1MHZ };
